...
<main>
	...
	<h2 class="rcb-header">Gallary Only For Our Members</h2>		<!-- login form header -->
		<section
		id="myCarouselcharity"
		class="carousel slide hme-main-img"
		data-ride="carousel"
		data-interval="8000"
	>	<!-- Have used bootstrap from w3school to do this navigation bar -->
		<ul class="carousel-inner">	<!-- containers with the images -->
			...
			<li class="item c-item img-container">
				...
				<img
						class="c-img"
						style="margin: auto;"
						src="./images/charity9.jpg"
						alt="Slide 3"
				/>
			</li>
		</ul>
		<!-- Left and right controls -->
		<a class="left carousel-control" href="#myCarouselcharity" data-slide="prev">
			<span class="glyphicon glyphicon-chevron-left"></span>
			<span class="sr-only">Previous</span>
		</a>
		<a class="right carousel-control" href="#myCarouselcharity" data-slide="next">
			<span class="glyphicon glyphicon-chevron-right"></span>
			<span class="sr-only">Next</span>
		</a>
	</section>
